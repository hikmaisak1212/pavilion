	...
	hero_shape: [
		{
			id: 1,
			cls: "tp-hero-shape-1",
			img: 'assets/img/hero/hero-line-shape.png',
		},
		{
			id: 2,
			cls: "tp-hero-shape-2",
			img: 'assets/img/hero/hero-line-shape-2.png',
		},
	],
	hero_title: (
		<>
	...
	hero_shape_img: [
		{
			id: 1,
			cls: "1",
			img: 'assets/img/hero/hero-shape-1.png',
		},
		{
			id: 2,
			cls: "2",
	...
	hero_thumbs: [
		{
			...
			col: "4",
			cls: "tp-hero__sm-img",
			img: 'assets/img/hero/hero-sm-3.png',
		},
		{
			id: 2,
			col: "8",
			cls: "",
			img: 'assets/img/hero/hero-sm-4.jp',
		},
	],
};
				...
				<div className="tp-hero__bg p-relative">
					<div className="tp-hero-bg tp-hero-bg-single" ref={hero_bg}>
						<img
							...
							src={"assets/img/hero/hero-frame.png"}
							alt="theme-pure"
						/>
					</div>
